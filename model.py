...
class Brand(db.Model):
    ...
    def __repr__(self):
        ...
        s = "<Brand brand_id=%s name=%s>"
        return s % (self.brand_id, self.name)
...
class Model(db.Model):
    ...
    def __repr__(self):
        ...
        s = "<Model model_id=%s year=%s brand_id=%s name=%s>"
        return s % (self.model_id, self.year, self.brand_id, self.name)
